...
class EncodeTest {
	...
	public static void main(String[] args) {
		...
		// 2.准备密文字符串
//		String encodedPassword = "$2a$10$rWERe4W7IzHwI/jbWihfo.VG78H5UiC4Q7uOgrWO6uxAKangfTwtK";
		String encodedPassword = "$2a$10$F3I8luVWRUoEkimE7l3pYOOOZ9v7V5vvYu70c0hu8baCBqjiuM9l2";
